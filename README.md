Ending in a 26gb .bin file, this .zip bomb has 17 layers of recursion, each .zip file is cloned 26 times, and each contains 26 more .zip files of the same format.
